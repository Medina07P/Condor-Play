...
### En PC Windows
1. Descarga el instalador: **[⬇ Descargar EXE](https://github.com/Medina07P/Condor-Play/releases/download/v3.8.1/condorplay-3.8.1.exe)**
2. Ejecuta `condorplay-3.8.1.exe` y sigue el asistente de instalación
